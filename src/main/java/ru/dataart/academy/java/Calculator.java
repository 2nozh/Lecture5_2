    ...
    public Integer getNumberOfChar(String zipFilePath, char character) {
        ...
        try (ZipInputStream zipInputStream = new ZipInputStream(new FileInputStream(zipFilePath))) {
            ...
            while ((entry = zipInputStream.getNextEntry()) != null) {
                FileOutputStream fout = new FileOutputStream("D:\\vrn-java-06 (2)\\src\\test\\resources\\" + entry.getName());
                ...
                BufferedReader br = new BufferedReader(new FileReader("D:\\vrn-java-06 (2)\\src\\test\\resources\\" + entry.getName()));
                int c;
                while ((c = br.read()) != -1) {
                    if (c == character) {
                        output++;
